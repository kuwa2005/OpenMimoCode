# OpenMimoCode 外部送信監査レポート

**監査日:** 2026-08-06  
**対象:** OpenMimoCode リポジトリ（ソース・スクリプト・インストーラ）  
...
| 項目 | 内容 |
|------|------|
| **送信先** | GitHub Releases（`https://github.com/kuwa2005/OpenMimoCode/releases/latest`）または npm registry（`@mimo-ai/cli`） |
...
| スクリプト | 外部通信 | 内容 |
|-----------|----------|------|
| `install` / `install.ps1` | GitHub Releases | プラットフォーム別バイナリ DL（`kuwa2005/OpenMimoCode`） |
