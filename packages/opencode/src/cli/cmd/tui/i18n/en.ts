export const dict: Record<string, string> = {
  ...
  "tui.tips.run": "Use {highlight}omimo run{/highlight} for non-interactive scripting",
  "tui.tips.continue": "Use {highlight}omimo --continue{/highlight} to resume the last session",
  "tui.tips.attach_cli": "Use {highlight}omimo run -f file.ts{/highlight} to attach files via CLI",
  "tui.tips.format_json": "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "tui.tips.serve": "Run {highlight}omimo serve{/highlight} for headless API access to MiMoCode",
  "tui.tips.attach_server": "Use {highlight}omimo run --attach{/highlight} to connect to a running server",
  "tui.tips.upgrade": "Run {highlight}omimo upgrade{/highlight} to update to the latest version",
  "tui.tips.auth_list": "Run {highlight}omimo auth list{/highlight} to see all configured providers",
  "tui.tips.agent_create": "Run {highlight}omimo agent create{/highlight} for guided agent creation",
  "tui.tips.github_install": "Run {highlight}omimo github install{/highlight} to set up the GitHub workflow",
  ...
  "tui.tips.debug_config": "Run {highlight}omimo debug config{/highlight} to troubleshoot configuration",
  ...
  "cli.providers.mimo_free.usage_hint": "No login required — just run omimo. For paid/premium models, choose MiMo browser login instead.",
