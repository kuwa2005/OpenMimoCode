...
export const dict = {
  ...
  "tui.home.agreement.prefix": "使用 Open Mimo Code 即表示你同意我们的",
  ...
  "tui.tips.free_api_sunset":
    "免费 API 服务已终止。请使用 {highlight}/login{/highlight} 登录，欢迎订阅MiMo Token Plan或配置第三方 API 后使用 Open Mimo Code。",
  ...
  "tui.tips.config_files":
    "创建 {highlight}oimo.json{/highlight} 用于服务端配置，{highlight}tui.json{/highlight} 用于 TUI 配置",
  "tui.tips.global_config": "把 TUI 配置放在 {highlight}~/.config/oimo/tui.json{/highlight} 作为全局配置",
  ...
  "tui.tips.mcp_oauth": "Open Mimo Code 自动处理需要鉴权的远程 MCP 服务器的 OAuth",
  "tui.tips.custom_command":
    "在 {highlight}.oimo/command/{/highlight} 添加 {highlight}.md{/highlight} 文件以定义可复用自定义提示",
  ...
  "tui.tips.custom_agent":
    "在 {highlight}.oimo/agent/{/highlight} 添加 {highlight}.md{/highlight} 文件来创建专用 AI 角色",
  ...
  "tui.tips.formatter": "Open Mimo Code 自动使用 prettier、gofmt、ruff 等格式化文件",
  ...
  "tui.tips.lsp": "Open Mimo Code 使用 LSP 服务器进行智能代码分析",
  "tui.tips.custom_tool":
    "在 {highlight}.oimo/tools/{/highlight} 创建 {highlight}.ts{/highlight} 文件定义新的 LLM 工具",
  "tui.tips.tool_scripts": "工具定义可以调用 Python、Go 等脚本",
  "tui.tips.plugins":
    "在 {highlight}.oimo/plugin/{/highlight} 添加 {highlight}.ts{/highlight} 文件挂接事件钩子",
  "tui.tips.plugin_notify": "用插件在会话完成时发送系统通知",
  "tui.tips.plugin_protect": "写一个插件阻止 Open Mimo Code 读取敏感文件",
  "tui.tips.run": "用 {highlight}oimo run{/highlight} 进行非交互式脚本调用",
  "tui.tips.continue": "用 {highlight}oimo --continue{/highlight} 继续上一个会话",
  "tui.tips.attach_cli": "用 {highlight}oimo run -f file.ts{/highlight} 通过命令行附加文件",
  "tui.tips.format_json": "用 {highlight}--format json{/highlight} 在脚本中获得机器可读输出",
  "tui.tips.serve": "运行 {highlight}oimo serve{/highlight} 以无头模式提供 Open Mimo Code API",
  "tui.tips.attach_server": "用 {highlight}oimo run --attach{/highlight} 接入正在运行的服务",
  "tui.tips.upgrade": "运行 {highlight}oimo upgrade{/highlight} 升级到最新版本",
  "tui.tips.auth_list": "运行 {highlight}oimo auth list{/highlight} 查看所有已配置的 provider",
  "tui.tips.agent_create": "运行 {highlight}oimo agent create{/highlight} 引导式创建智能体",
  "tui.tips.github_install": "运行 {highlight}oimo github install{/highlight} 配置 GitHub workflow",
  ...
  "tui.tips.theme_files": "在 {highlight}.oimo/themes/{/highlight} 目录下创建 JSON 主题文件",
  ...
  "tui.tips.debug_config": "运行 {highlight}oimo debug config{/highlight} 排查配置问题",
  ...
  "tui.tips.zen": "搭配 Open Mimo Code 使用 {highlight}/connect{/highlight} 选用经过测试的精选模型",
  ...
  "tui.slash.evolve.description": "Self Improvement Session：将知识结晶为 skill，维护 backlog，分析摩擦/HAC，并写出改进 oimo 的指示书",
  "tui.slash.self-improve.description": "/evolve 的别名 — 运行自我改进会话（观察→提案→指示书）",
  ...
  "tui.skill.oimo.description": "Open Mimo Code 功能、配置与命令的自文档参考",
  "tui.skill.evolve.description": "改写自身的一切——工具、行为钩子、知识技能、工作流、界面——并写出供外部智能体改进 oimo 产品的指示书",
  ...
  "tui.skill.drive-mimo.description": "以编程方式驱动另一个 Open Mimo Code 进程——无头 JSON 事件或通过 tmux 交互",
  ...
  "tui.skill.oimo.slash": "Open Mimo Code文档",
  ...
  "tui.skill.drive-mimo.slash": "驱动Open Mimo Code",
  ...
  "tui.context_limit.scalar_config": "compaction.max_context 当前是对所有模型生效的单值，请在 oimo.json 中改为按模型配置",
  "tui.context_limit.shadowed": "已保存，但仍有其他配置将其固定为 {{value}}，请检查项目的 oimo.json",
  ...
  "tui.dialog.free_api_sunset.message":
    "请使用 /login 登录，欢迎订阅MiMo Token Plan或配置第三方 API 后使用 Open Mimo Code。",
  ...
  "tui.toast.try_best.auto_continue": "同一操作卡住了 — 暂停后改用其他方案继续。",
  ...
  "tui.toast.update_available.success": "已更新到 Open Mimo Code v{{version}}，请重启应用。",
  ...
  "cli.providers.mimo_free.usage_hint": "无需登录，直接 oimo run 即可使用。如需付费/更高级模型，可重新选择 MiMo 浏览器登录。",
  ...
  "trust.capabilities": "Open Mimo Code 将能够读取、编辑和执行此目录中的文件。",
