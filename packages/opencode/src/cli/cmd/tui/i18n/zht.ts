...
export const dict = {
  ...
  "tui.tips.run": "用 {highlight}omimo run{/highlight} 進行非互動式指令稿呼叫",
  "tui.tips.continue": "用 {highlight}omimo --continue{/highlight} 繼續上一個工作階段",
  "tui.tips.attach_cli": "用 {highlight}omimo run -f file.ts{/highlight} 透過命令列附加檔案",
  "tui.tips.format_json": "用 {highlight}--format json{/highlight} 在指令稿中取得機器可讀輸出",
  "tui.tips.serve": "執行 {highlight}omimo serve{/highlight} 以無介面模式提供 MiMoCode API",
  "tui.tips.attach_server": "用 {highlight}omimo run --attach{/highlight} 連線到正在執行的服務",
  "tui.tips.upgrade": "執行 {highlight}omimo upgrade{/highlight} 升級到最新版本",
  "tui.tips.auth_list": "執行 {highlight}omimo auth list{/highlight} 檢視所有已設定的供應商",
  "tui.tips.agent_create": "執行 {highlight}omimo agent create{/highlight} 引導式建立智慧代理",
  "tui.tips.github_install": "執行 {highlight}omimo github install{/highlight} 設定 GitHub workflow",
  ...
  "tui.tips.debug_config": "執行 {highlight}omimo debug config{/highlight} 排查設定問題",
