...
export const dict = {
  ...
  "tui.home.agreement.prefix": "En utilisant Open Mimo Code, vous acceptez nos ",
  ...
  "tui.tips.free_api_sunset":
    "Le service API gratuit est terminé. Exécutez {highlight}/login{/highlight} pour vous connecter. Abonnez-vous au MiMo Token Plan ou configurez une API tierce pour utiliser Open Mimo Code.",
  ...
  "tui.tips.config_files":
    "Créez {highlight}oimo.json{/highlight} pour la configuration serveur et {highlight}tui.json{/highlight} pour le TUI",
  "tui.tips.global_config":
    "Placez les paramètres TUI dans {highlight}~/.config/oimo/tui.json{/highlight} comme configuration globale",
  ...
  "tui.tips.mcp_oauth":
    "Open Mimo Code gère automatiquement OAuth pour les serveurs MCP distants nécessitant une authentification",
  "tui.tips.custom_command":
    "Ajoutez des fichiers {highlight}.md{/highlight} dans {highlight}.oimo/command/{/highlight} pour définir des invites personnalisées réutilisables",
  ...
  "tui.tips.custom_agent":
    "Ajoutez des fichiers {highlight}.md{/highlight} dans {highlight}.oimo/agent/{/highlight} pour des personas IA spécialisés",
  ...
  "tui.tips.formatter": "Open Mimo Code formate automatiquement les fichiers avec prettier, gofmt, ruff, etc.",
  ...
  "tui.tips.lsp": "Open Mimo Code utilise des serveurs LSP pour une analyse de code intelligente",
  "tui.tips.custom_tool":
    "Créez des fichiers {highlight}.ts{/highlight} dans {highlight}.oimo/tools/{/highlight} pour définir de nouveaux outils LLM",
  "tui.tips.tool_scripts": "Les définitions d'outils peuvent invoquer des scripts en Python, Go, etc.",
  "tui.tips.plugins":
    "Ajoutez des fichiers {highlight}.ts{/highlight} dans {highlight}.oimo/plugin/{/highlight} pour des hooks d'événements",
  ...
  "tui.tips.plugin_protect":
    "Créez un plugin pour empêcher Open Mimo Code de lire des fichiers sensibles",
  "tui.tips.run": "Utilisez {highlight}oimo run{/highlight} pour des scripts non interactifs",
  "tui.tips.continue": "Utilisez {highlight}oimo --continue{/highlight} pour reprendre la dernière session",
  "tui.tips.attach_cli":
    "Utilisez {highlight}oimo run -f file.ts{/highlight} pour joindre des fichiers via la CLI",
  "tui.tips.format_json":
    "Utilisez {highlight}--format json{/highlight} pour une sortie lisible par machine dans les scripts",
  "tui.tips.serve": "Exécutez {highlight}oimo serve{/highlight} pour exposer l'API Open Mimo Code en mode headless",
  "tui.tips.attach_server":
    "Utilisez {highlight}oimo run --attach{/highlight} pour vous connecter à un serveur en cours",
  "tui.tips.upgrade": "Exécutez {highlight}oimo upgrade{/highlight} pour passer à la dernière version",
  "tui.tips.auth_list":
    "Exécutez {highlight}oimo auth list{/highlight} pour voir tous les fournisseurs configurés",
  "tui.tips.agent_create":
    "Exécutez {highlight}oimo agent create{/highlight} pour créer un agent en mode guidé",
  "tui.tips.github_install":
    "Exécutez {highlight}oimo github install{/highlight} pour configurer le workflow GitHub",
  "tui.tips.github_oc":
  ...
  "tui.tips.theme_files":
    "Créez des fichiers de thème JSON dans le dossier {highlight}.oimo/themes/{/highlight}",
  ...
  "tui.tips.debug_config":
    "Exécutez {highlight}oimo debug config{/highlight} pour diagnostiquer la configuration",
  "tui.tips.print_logs":
  ...
  "tui.tips.zen":
    "Utilisez {highlight}/connect{/highlight} avec Open Mimo Code pour des modèles testés et sélectionnés",
  "tui.tips.agents_md":
  ...
  "tui.slash.evolve.description":
    "Self Improvement Session : skills, backlog, friction/HAC et briefs AI-to-AI pour faire évoluer oimo",
  "tui.slash.self-improve.description":
    "alias de /evolve — lancer une Self Improvement Session",
  ...
  "tui.skill.oimo.description": "Documentation intégrée des fonctionnalités, config et commandes Open Mimo Code",
  ...
  "tui.skill.drive-mimo.description": "Piloter un autre processus Open Mimo Code — événements JSON headless ou TUI interactive via tmux",
  ...
  "tui.dialog.free_api_sunset.message":
    "Exécutez /login pour vous connecter. Abonnez-vous au MiMo Token Plan ou configurez une API tierce pour utiliser Open Mimo Code.",
  ...
  "tui.toast.update_available.success": "Mis à jour vers Open Mimo Code v{{version}}. Veuillez redémarrer l'application.",
  ...
  "cli.providers.mimo_free.usage_hint":
    "Aucune connexion requise — exécutez simplement oimo. Pour les modèles payants/premium, choisissez plutôt la connexion navigateur MiMo.",
  ...
  "trust.capabilities": "Open Mimo Code pourra lire, modifier et exécuter des fichiers ici.",
