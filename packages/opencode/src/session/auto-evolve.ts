...
export function buildEvolveTask(input: {
  ...
  const lines = [
    ...
    "write proposals under `.oimo/` for the user to review and hand to an external coding agent.",
    "",
    ...
    "Inventory existing `.oimo/skills` and `.oimo/evolve` assets first; prefer extend over duplicate.",
    "Write skills under `.oimo/skills/`, briefs under `.oimo/evolve/briefs/`, friction under `.oimo/evolve/friction/`,",
    "backlog at `.oimo/evolve/backlog/BACKLOG.md`, reviews under `.oimo/evolve/reviews/`,",
    "and keep `.oimo/evolve/INDEX.md` + `.oimo/evolve/history/HISTORY.md` current.",
