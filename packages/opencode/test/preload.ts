...
const dir = path.join(os.tmpdir(), "oimo-test-data-" + process.pid)
...
const fixtureRoot = path.join(process.cwd(), ".oimo-test-fixtures-" + process.pid)
...
const cacheDir = path.join(dir, "cache", "oimo")
